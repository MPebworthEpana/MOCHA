...
#'   further customization. Note that gene-symbol lookup for the
#'   'whichGenes' option requires either an installed \pkg{AnnotationDbi} +
#'   OrgDb package (offline) or a \pkg{biomaRt} \code{Mart} connection
#'   (online).
#'
